...
const connectDB = async () => {
    ...
    try {
        ...
        // tslint:disable-next-line:no-console
        console.log(pink.bold.italic("> 🚀 Connected Successfully to The Database!"));
        // tslint:disable-next-line:no-console
        console.log(notice.bold(`> ⭐️ Database Connected to ${data.connection.host}:${data.connection.port}`));
